...
for idx in range(1, iterations+1):
    ...
    if idx % epoch_size == 0:
        ...
        print(f'#{idx/epoch_idx}/{epoch_size} - {elapsed*1000:.3f}ms - loss:{loss:.3f} - accuracy:(train, test)=({train_accuracy:.3f},{test_accuracy:.3f}')
...
with open (params_file, 'wb') as f_params,\
    ...
    pickle.dump(train_losses, f_testacc, -1)
